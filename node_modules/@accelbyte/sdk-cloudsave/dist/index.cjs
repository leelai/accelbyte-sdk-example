...
__export(src_exports, {
  AdminConcurrentRecordRequest: () => AdminConcurrentRecordRequest,
  AdminGameConcurrentRecordRequest: () => AdminGameConcurrentRecordRequest,
  AdminGameRecordRequest: () => AdminGameRecordRequest,
  AdminGameRecordResponse: () => AdminGameRecordResponse,
  AdminPlayerConcurrentRecordRequest: () => AdminPlayerConcurrentRecordRequest,
  AdminPlayerRecordKeyInfo: () => AdminPlayerRecordKeyInfo,
  AdminPlayerRecordRequest: () => AdminPlayerRecordRequest,
  AdminPlayerRecordResponse: () => AdminPlayerRecordResponse,
  AppConfig: () => AppConfig,
  BinaryInfoResponse: () => BinaryInfoResponse,
  BinaryRecordRequest: () => BinaryRecordRequest,
  BulkGetAdminGameRecordRequest: () => BulkGetAdminGameRecordRequest,
  BulkGetAdminGameRecordResponse: () => BulkGetAdminGameRecordResponse,
  BulkGetAdminPlayerRecordRequest: () => BulkGetAdminPlayerRecordRequest,
  BulkGetAdminPlayerRecordResponse: () => BulkGetAdminPlayerRecordResponse,
  BulkGetGameBinaryRecordResponse: () => BulkGetGameBinaryRecordResponse,
  BulkGetGameRecordRequest: () => BulkGetGameRecordRequest,
  BulkGetGameRecordResponse: () => BulkGetGameRecordResponse,
  BulkGetPlayerBinaryRecordResponse: () => BulkGetPlayerBinaryRecordResponse,
  BulkGetPlayerRecordResponse: () => BulkGetPlayerRecordResponse,
  BulkGetPlayerRecordSizeResponse: () => BulkGetPlayerRecordSizeResponse,
  BulkGetPlayerRecordsRequest: () => BulkGetPlayerRecordsRequest,
  BulkUpdatePlayerRecordByKeyRequestDetail: () => BulkUpdatePlayerRecordByKeyRequestDetail,
  BulkUpdatePlayerRecordByKeyResponse: () => BulkUpdatePlayerRecordByKeyResponse,
  BulkUpdatePlayerRecordByKeyResponseArray: () => BulkUpdatePlayerRecordByKeyResponseArray,
  BulkUpdatePlayerRecordRequestDetail: () => BulkUpdatePlayerRecordRequestDetail,
  BulkUpdatePlayerRecordResponse: () => BulkUpdatePlayerRecordResponse,
  BulkUpdatePlayerRecordResponseArray: () => BulkUpdatePlayerRecordResponseArray,
  BulkUpdatePlayerRecordsByKeyRequest: () => BulkUpdatePlayerRecordsByKeyRequest,
  BulkUpdatePlayerRecordsRequest: () => BulkUpdatePlayerRecordsRequest,
  BulkUserIDsRequest: () => BulkUserIDsRequest,
  BulkUserKeyRequest: () => BulkUserKeyRequest,
  Cloudsave: () => Cloudsave,
  ConcurrentRecord$: () => ConcurrentRecord$,
  ConcurrentRecordAdmin$: () => ConcurrentRecordAdmin$,
  ConcurrentRecordAdminApi: () => ConcurrentRecordAdminApi,
  ConcurrentRecordApi: () => ConcurrentRecordApi,
  ConcurrentRecordRequest: () => ConcurrentRecordRequest,
  CustomConfig: () => CustomConfig,
  CustomFunction: () => CustomFunction,
  GameBinaryRecordAdmin$: () => GameBinaryRecordAdmin$,
  GameBinaryRecordAdminApi: () => GameBinaryRecordAdminApi,
  GameBinaryRecordAdminResponse: () => GameBinaryRecordAdminResponse,
  GameBinaryRecordCreate: () => GameBinaryRecordCreate,
  GameBinaryRecordMetadataRequest: () => GameBinaryRecordMetadataRequest,
  GameBinaryRecordResponse: () => GameBinaryRecordResponse,
  GameRecordAdmin$: () => GameRecordAdmin$,
  GameRecordAdminApi: () => GameRecordAdminApi,
  GameRecordAdminResponse: () => GameRecordAdminResponse,
  GameRecordRequest: () => GameRecordRequest,
  GameRecordResponse: () => GameRecordResponse,
  ListAdminGameRecordKeysResponse: () => ListAdminGameRecordKeysResponse,
  ListAdminPlayerRecordKeysResponse: () => ListAdminPlayerRecordKeysResponse,
  ListGameBinaryRecordsAdminResponse: () => ListGameBinaryRecordsAdminResponse,
  ListGameBinaryRecordsResponse: () => ListGameBinaryRecordsResponse,
  ListGameRecordKeysResponse: () => ListGameRecordKeysResponse,
  ListPlayerBinaryRecordsResponse: () => ListPlayerBinaryRecordsResponse,
  ListPlayerRecordKeysResponse: () => ListPlayerRecordKeysResponse,
  ListTagsResponse: () => ListTagsResponse,
  Pagination: () => Pagination,
  PlayerBinaryRecordAdmin$: () => PlayerBinaryRecordAdmin$,
  PlayerBinaryRecordAdminApi: () => PlayerBinaryRecordAdminApi,
  PlayerBinaryRecordCreate: () => PlayerBinaryRecordCreate,
  PlayerBinaryRecordMetadataPublicRequest: () => PlayerBinaryRecordMetadataPublicRequest,
  PlayerBinaryRecordMetadataRequest: () => PlayerBinaryRecordMetadataRequest,
  PlayerBinaryRecordResponse: () => PlayerBinaryRecordResponse,
  PlayerRecordAdmin$: () => PlayerRecordAdmin$,
  PlayerRecordAdminApi: () => PlayerRecordAdminApi,
  PlayerRecordConcurrentUpdateResponse: () => PlayerRecordConcurrentUpdateResponse,
  PlayerRecordKeyInfo: () => PlayerRecordKeyInfo,
  PlayerRecordRequest: () => PlayerRecordRequest,
  PlayerRecordResponse: () => PlayerRecordResponse,
  PlayerRecordSizeResponse: () => PlayerRecordSizeResponse,
  PluginConfigAdmin$: () => PluginConfigAdmin$,
  PluginConfigAdminApi: () => PluginConfigAdminApi,
  PluginRequest: () => PluginRequest,
  PluginResponse: () => PluginResponse,
  PublicGameBinaryRecord$: () => PublicGameBinaryRecord$,
  PublicGameBinaryRecordApi: () => PublicGameBinaryRecordApi,
  PublicGameBinaryRecordCreate: () => PublicGameBinaryRecordCreate,
  PublicGameRecord$: () => PublicGameRecord$,
  PublicGameRecordApi: () => PublicGameRecordApi,
  PublicPlayerBinaryRecord$: () => PublicPlayerBinaryRecord$,
  PublicPlayerBinaryRecordApi: () => PublicPlayerBinaryRecordApi,
  PublicPlayerBinaryRecordCreate: () => PublicPlayerBinaryRecordCreate,
  PublicPlayerRecord$: () => PublicPlayerRecord$,
  PublicPlayerRecordApi: () => PublicPlayerRecordApi,
  PublicTags$: () => PublicTags$,
  PublicTagsApi: () => PublicTagsApi,
  RecordAdmin$: () => RecordAdmin$,
  RecordAdminApi: () => RecordAdminApi,
  ResponseError: () => ResponseError,
  TagInfo: () => TagInfo,
  TagRequest: () => TagRequest,
  TagsAdmin$: () => TagsAdmin$,
  TagsAdminApi: () => TagsAdminApi,
  TtlConfigAdmin$: () => TtlConfigAdmin$,
  TtlConfigAdminApi: () => TtlConfigAdminApi,
  TtlConfigDto: () => TtlConfigDto,
  UploadBinaryRecordRequest: () => UploadBinaryRecordRequest,
  UploadBinaryRecordResponse: () => UploadBinaryRecordResponse,
...
var AdminConcurrentRecordRequest = import_zod55.z.object({
  set_by: import_zod55.z.enum(["CLIENT", "SERVER"]),
  tags: import_zod55.z.array(import_zod55.z.string()).nullish(),
  ttl_config: TtlConfigDto.nullish(),
  updatedAt: import_zod55.z.string(),
  value: import_zod55.z.record(import_zod55.z.any())
});

// src/generated-definitions/AdminGameConcurrentRecordRequest.ts
var import_zod56 = require("zod");
var AdminGameConcurrentRecordRequest = import_zod56.z.object({
  tags: import_zod56.z.array(import_zod56.z.string()).nullish(),
  updatedAt: import_zod56.z.string(),
  value: import_zod56.z.record(import_zod56.z.any())
});

// src/generated-definitions/AdminGameRecordRequest.ts
var import_zod57 = require("zod");
var AdminGameRecordRequest = import_zod57.z.any();

// src/generated-definitions/AdminPlayerConcurrentRecordRequest.ts
var import_zod58 = require("zod");
var AdminPlayerConcurrentRecordRequest = import_zod58.z.object({
  tags: import_zod58.z.array(import_zod58.z.string()).nullish(),
  updatedAt: import_zod58.z.string(),
  value: import_zod58.z.record(import_zod58.z.any())
});

// src/generated-definitions/AdminPlayerRecordRequest.ts
var import_zod59 = require("zod");
var AdminPlayerRecordRequest = import_zod59.z.any();

// src/generated-definitions/BinaryRecordRequest.ts
var import_zod60 = require("zod");
var BinaryRecordRequest = import_zod60.z.object({ content_type: import_zod60.z.string(), file_location: import_zod60.z.string() });

// src/generated-definitions/BulkGetAdminGameRecordRequest.ts
var import_zod61 = require("zod");
var BulkGetAdminGameRecordRequest = import_zod61.z.object({ keys: import_zod61.z.array(import_zod61.z.string()) });

// src/generated-definitions/BulkGetAdminPlayerRecordRequest.ts
var import_zod62 = require("zod");
var BulkGetAdminPlayerRecordRequest = import_zod62.z.object({ keys: import_zod62.z.array(import_zod62.z.string()) });

// src/generated-definitions/BulkGetGameRecordRequest.ts
var import_zod63 = require("zod");
var BulkGetGameRecordRequest = import_zod63.z.object({ keys: import_zod63.z.array(import_zod63.z.string()) });

// src/generated-definitions/BulkGetPlayerRecordsRequest.ts
var import_zod64 = require("zod");
var BulkGetPlayerRecordsRequest = import_zod64.z.object({ keys: import_zod64.z.array(import_zod64.z.string()) });

// src/generated-definitions/BulkUpdatePlayerRecordByKeyRequestDetail.ts
var import_zod65 = require("zod");
var BulkUpdatePlayerRecordByKeyRequestDetail = import_zod65.z.object({ user_id: import_zod65.z.string(), value: import_zod65.z.record(import_zod65.z.any()) });

// src/generated-definitions/BulkUpdatePlayerRecordRequestDetail.ts
var import_zod66 = require("zod");
var BulkUpdatePlayerRecordRequestDetail = import_zod66.z.object({ key: import_zod66.z.string(), value: import_zod66.z.record(import_zod66.z.any()) });

// src/generated-definitions/BulkUpdatePlayerRecordsByKeyRequest.ts
var import_zod67 = require("zod");
var BulkUpdatePlayerRecordsByKeyRequest = import_zod67.z.object({ data: import_zod67.z.array(BulkUpdatePlayerRecordByKeyRequestDetail) });

// src/generated-definitions/BulkUpdatePlayerRecordsRequest.ts
var import_zod68 = require("zod");
var BulkUpdatePlayerRecordsRequest = import_zod68.z.object({ data: import_zod68.z.array(BulkUpdatePlayerRecordRequestDetail) });

// src/generated-definitions/BulkUserIDsRequest.ts
var import_zod69 = require("zod");
var BulkUserIDsRequest = import_zod69.z.object({ userIds: import_zod69.z.array(import_zod69.z.string()) });
...
var UserKeyRequest = import_zod70.z.object({ keys: import_zod70.z.array(import_zod70.z.string()), user_id: import_zod70.z.string() });

// src/generated-definitions/BulkUserKeyRequest.ts
var BulkUserKeyRequest = import_zod71.z.object({ data: import_zod71.z.array(UserKeyRequest) });

// src/generated-definitions/ConcurrentRecordRequest.ts
var import_zod72 = require("zod");
var ConcurrentRecordRequest = import_zod72.z.object({ updatedAt: import_zod72.z.string(), value: import_zod72.z.record(import_zod72.z.any()) });

// src/generated-definitions/GameBinaryRecordCreate.ts
var import_zod73 = require("zod");
var GameBinaryRecordCreate = import_zod73.z.object({
  file_type: import_zod73.z.string(),
  key: import_zod73.z.string(),
  set_by: import_zod73.z.enum(["CLIENT", "SERVER"]),
  ttl_config: TtlConfigDto.nullish()
});

// src/generated-definitions/GameBinaryRecordMetadataRequest.ts
var import_zod74 = require("zod");
var GameBinaryRecordMetadataRequest = import_zod74.z.object({
  set_by: import_zod74.z.enum(["CLIENT", "SERVER"]),
  tags: import_zod74.z.array(import_zod74.z.string()).nullish(),
  ttl_config: TtlConfigDto.nullish()
});

// src/generated-definitions/GameRecordRequest.ts
var import_zod75 = require("zod");
var GameRecordRequest = import_zod75.z.any();

// src/generated-definitions/PlayerBinaryRecordCreate.ts
var import_zod76 = require("zod");
var PlayerBinaryRecordCreate = import_zod76.z.object({
  file_type: import_zod76.z.string(),
  is_public: import_zod76.z.boolean().nullish(),
  key: import_zod76.z.string(),
  set_by: import_zod76.z.enum(["CLIENT", "SERVER"])
});

// src/generated-definitions/PlayerBinaryRecordMetadataPublicRequest.ts
var import_zod77 = require("zod");
var PlayerBinaryRecordMetadataPublicRequest = import_zod77.z.object({ is_public: import_zod77.z.boolean().nullish() });

// src/generated-definitions/PlayerBinaryRecordMetadataRequest.ts
var import_zod78 = require("zod");
var PlayerBinaryRecordMetadataRequest = import_zod78.z.object({
  is_public: import_zod78.z.boolean().nullish(),
  set_by: import_zod78.z.enum(["CLIENT", "SERVER"]).nullish(),
  tags: import_zod78.z.array(import_zod78.z.string()).nullish()
});

// src/generated-definitions/PlayerRecordRequest.ts
var import_zod79 = require("zod");
var PlayerRecordRequest = import_zod79.z.any();

// src/generated-definitions/PluginRequest.ts
var import_zod80 = require("zod");
var PluginRequest = import_zod80.z.object({
  appConfig: AppConfig.nullish(),
  customConfig: CustomConfig.nullish(),
  customFunction: CustomFunction,
  extendType: import_zod80.z.enum(["APP", "CUSTOM"])
});

// src/generated-definitions/PublicGameBinaryRecordCreate.ts
var import_zod81 = require("zod");
var PublicGameBinaryRecordCreate = import_zod81.z.object({ file_type: import_zod81.z.string(), key: import_zod81.z.string() });

// src/generated-definitions/PublicPlayerBinaryRecordCreate.ts
var import_zod82 = require("zod");
var PublicPlayerBinaryRecordCreate = import_zod82.z.object({ file_type: import_zod82.z.string(), is_public: import_zod82.z.boolean().nullish(), key: import_zod82.z.string() });

// src/generated-definitions/ResponseError.ts
var import_zod83 = require("zod");
var ResponseError = import_zod83.z.object({ errorCode: import_zod83.z.number().int(), errorMessage: import_zod83.z.string() });

// src/generated-definitions/TagRequest.ts
var import_zod84 = require("zod");
var TagRequest = import_zod84.z.object({ tag: import_zod84.z.string() });

// src/generated-definitions/UploadBinaryRecordRequest.ts
var import_zod85 = require("zod");
var UploadBinaryRecordRequest = import_zod85.z.object({ file_type: import_zod85.z.string() });
