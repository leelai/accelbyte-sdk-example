...
__export(src_exports, {
  AcquiringDs: () => AcquiringDs,
  AcquiringDsWaitTime: () => AcquiringDsWaitTime,
  AllianceRule: () => AllianceRule,
  BackfillProposal: () => BackfillProposal,
  BackfillTicket: () => BackfillTicket,
  CanceledMatchmakingTicket: () => CanceledMatchmakingTicket,
  ConfigAdmin$: () => ConfigAdmin$,
  ConfigAdminApi: () => ConfigAdminApi,
  Configuration: () => Configuration,
  CreatedMatchmakingTicket: () => CreatedMatchmakingTicket,
  DsInformation: () => DsInformation,
  Error: () => Error2,
  EventMatchHistory: () => EventMatchHistory,
  ExpiredMatchmakingTicket: () => ExpiredMatchmakingTicket,
  GameServer: () => GameServer,
  GameSession: () => GameSession,
  GameSessionDetail: () => GameSessionDetail,
  GameSessionDetail$: () => GameSessionDetail$,
  GameSessionDetailAdmin$: () => GameSessionDetailAdmin$,
  GameSessionDetailAdminApi: () => GameSessionDetailAdminApi,
  GameSessionDetailApi: () => GameSessionDetailApi,
  GameSessionDetailQueryResponse: () => GameSessionDetailQueryResponse,
  GameSessionTeam: () => GameSessionTeam,
  History: () => History,
  Match: () => Match,
  MatchLengthDuration: () => MatchLengthDuration,
  MatchMatchmaking: () => MatchMatchmaking,
  MatchMatchmakingTicket: () => MatchMatchmakingTicket,
  MatchTicket: () => MatchTicket,
  MatchingAlly: () => MatchingAlly,
  MatchingParty: () => MatchingParty,
  MatchingRule: () => MatchingRule,
  MatchmakingDetail: () => MatchmakingDetail,
  MatchmakingDetailQueryResponse: () => MatchmakingDetailQueryResponse,
  MatchmakingHistory: () => MatchmakingHistory,
  MatchmakingResult: () => MatchmakingResult,
  Pagination: () => Pagination,
  Party: () => Party,
  PartyDetail: () => PartyDetail,
  PartyDetailQueryResponse: () => PartyDetailQueryResponse,
  ...
  TicketDetailQueryResponse: () => TicketDetailQueryResponse,
  TicketObservability: () => TicketObservability,
  TicketObservabilityDetail: () => TicketObservabilityDetail,
  TicketObservabilityHistory: () => TicketObservabilityHistory,
  TicketStatus: () => TicketStatus,
  TotalActiveSession: () => TotalActiveSession,
  TotalPlayerPersession: () => TotalPlayerPersession,
  User: () => User,
  XRayAcquiringDsQueryResponse: () => XRayAcquiringDsQueryResponse,
  XRayAcquiringDsWaitTimeQueryResponse: () => XRayAcquiringDsWaitTimeQueryResponse,
  XRayAdmin$: () => XRayAdmin$,
  XRayAdminApi: () => XRayAdminApi,
  XRayBulkTicketObservabilityRequest: () => XRayBulkTicketObservabilityRequest,
  XRayBulkTicketObservabilityResponse: () => XRayBulkTicketObservabilityResponse,
  XRayCanceledMatchmakingTicketQueryResponse: () => XRayCanceledMatchmakingTicketQueryResponse,
  XRayCreatedMatchmakingTicketQueryResponse: () => XRayCreatedMatchmakingTicketQueryResponse,
  XRayExpiredMatchmakingTicketQueryResponse: () => XRayExpiredMatchmakingTicketQueryResponse,
  XRayMatchHistorQueryResponse: () => XRayMatchHistorQueryResponse,
  XRayMatchLengthDurationQueryResponse: () => XRayMatchLengthDurationQueryResponse,
  XRayMatchMatchmakingQueryResponse: () => XRayMatchMatchmakingQueryResponse,
  XRayMatchMatchmakingTicketQueryResponse: () => XRayMatchMatchmakingTicketQueryResponse,
  XRayMatchPoolPodTickMatchResponse: () => XRayMatchPoolPodTickMatchResponse,
  XRayMatchPoolPodTickQueryResponse: () => XRayMatchPoolPodTickQueryResponse,
  XRayMatchPoolPodTickResult: () => XRayMatchPoolPodTickResult,
  XRayMatchPoolPodTickTicketResponse: () => XRayMatchPoolPodTickTicketResponse,
  XRayMatchPoolQueryResponse: () => XRayMatchPoolQueryResponse,
  XRayMatchPoolResult: () => XRayMatchPoolResult,
  XRayMatchTicketHistory: () => XRayMatchTicketHistory,
  XRayMatchTicketHistoryQueryResponse: () => XRayMatchTicketHistoryQueryResponse,
  XRayMatchesQueryResponse: () => XRayMatchesQueryResponse,
  XRayTicketMatchesResult: () => XRayTicketMatchesResult,
  XRayTicketObservabilityRequest: () => XRayTicketObservabilityRequest,
  XRayTicketObservabilityResponse: () => XRayTicketObservabilityResponse,
  XRayTicketQueryResponse: () => XRayTicketQueryResponse,
  XRayTicketResult: () => XRayTicketResult,
  XRayTotalActiveSessionQueryResponse: () => XRayTotalActiveSessionQueryResponse,
  XRayTotalPlayerPersessionAvgQueryResponse: () => XRayTotalPlayerPersessionAvgQueryResponse
});
...
var XRayAdmin$ = class {
  ...
  createXrayTicket_v2(data) {
    ...
    return import_sdk4.Validate.validateOrReturnResponse(
      this.useSchemaValidation,
      () => resultPromise,
...
function GameSessionDetailAdminApi(sdk, args) {
  ...
  const interceptorsOverride = args?.axiosConfig?.interceptors ?? [];
  if (requestConfigOverrides || baseURLOverride || interceptorsOverride.length > 0) {
    const requestConfig = import_sdk5.ApiUtils.mergeAxiosConfigs(sdkAssembly.axiosInstance.defaults, {
      ...baseURLOverride ? { baseURL: baseURLOverride } : {},
      ...requestConfigOverrides
    });
    axiosInstance = import_sdk5.Network.create(requestConfig);
    for (const interceptor of interceptorsOverride) {
      if (interceptor.type === "request") {
        axiosInstance.interceptors.request.use(interceptor.onRequest, interceptor.onError);
      }
...
var Error2 = import_zod78.z.object({
  attributes: import_zod78.z.record(import_zod78.z.string()),
  errorCode: import_zod78.z.number().int(),
  errorMessage: import_zod78.z.string(),
  message: import_zod78.z.string(),
  name: import_zod78.z.string()
});

// src/generated-definitions/XRayBulkTicketObservabilityRequest.ts
var import_zod80 = require("zod");

// src/generated-definitions/XRayTicketObservabilityRequest.ts
var import_zod79 = require("zod");
var XRayTicketObservabilityRequest = import_zod79.z.object({
  action: import_zod79.z.string(),
  activeAllianceRule: AllianceRule.nullish(),
  activeMatchingRule: import_zod79.z.array(MatchingRule).nullish(),
  function: import_zod79.z.string().nullish(),
  gameMode: import_zod79.z.string(),
  isBackfillMatch: import_zod79.z.boolean(),
  isRuleSetFlexed: import_zod79.z.boolean(),
  iteration: import_zod79.z.number().int().nullish(),
  matchID: import_zod79.z.string().nullish(),
  namespace: import_zod79.z.string(),
  remainingPlayersPerTicket: import_zod79.z.array(import_zod79.z.number().int()).nullish(),
  remainingTickets: import_zod79.z.number().int().nullish(),
  sessionTickID: import_zod79.z.string(),
  tickID: import_zod79.z.number().int(),
  ticketID: import_zod79.z.string(),
  timeToMatchSec: import_zod79.z.number().nullish(),
  timestamp: import_zod79.z.string(),
  unbackfillReason: import_zod79.z.string().nullish(),
  unmatchReason: import_zod79.z.string().nullish()
});

// src/generated-definitions/XRayBulkTicketObservabilityRequest.ts
var XRayBulkTicketObservabilityRequest = import_zod80.z.object({ ticketObservabilities: import_zod80.z.array(XRayTicketObservabilityRequest) });
...
// package.json
var name = "@accelbyte/sdk-sessionhistory";
var version = "5.0.4";
...
0 && (module.exports = {
  ...
  XRayAdmin$,
  XRayAdminApi,
  XRayBulkTicketObservabilityRequest,
  XRayBulkTicketObservabilityResponse,
  XRayCanceledMatchmakingTicketQueryResponse,
  XRayCreatedMatchmakingTicketQueryResponse,
  XRayExpiredMatchmakingTicketQueryResponse,
  ...
  XRayTicketObservabilityRequest,
  XRayTicketObservabilityResponse,
  XRayTicketQueryResponse,
  XRayTicketResult,
  XRayTotalActiveSessionQueryResponse,
