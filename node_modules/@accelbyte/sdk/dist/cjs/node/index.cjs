...
var AccelByteSDK = class _AccelByteSDK {
  constructor({ coreConfig, axiosConfig, webSocketConfig }) {
    ...
    this.webSocketConfig = {
      allowReconnect: (webSocketConfig == null ? void 0 : webSocketConfig.allowReconnect) ?? true,
      maxReconnectAttempts: (webSocketConfig == null ? void 0 : webSocketConfig.maxReconnectAttempts) ?? 0
    };
    this.token = {};
  }
  createAxiosInstance() {
